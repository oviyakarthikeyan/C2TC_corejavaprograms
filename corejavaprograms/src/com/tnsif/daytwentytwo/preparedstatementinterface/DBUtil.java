...
public class DBUtil {
	...
	private static final String DB_USERNAME = "postgre";
	private static final String DB_PASSWORD = "Kovi@8030";
	private static final String DB_URL = "jdbc:mysql://localhost:5432/employee";
